...
import ChangeResultsScreen from './ResultsScreen';
...
export default function ChangeAssessment({ user }) {
  const { answers, setAnswers, scores, setScores, loaded } = useAssessment('change_assessments', user?.id);
  ...
  if (view === 'results') {
    return <ChangeResultsScreen scores={scores} onRetake={handleRetake} />;
  }
