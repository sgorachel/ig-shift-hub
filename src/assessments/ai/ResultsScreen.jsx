...
export default function AiResultsScreen({ scores, onRetake }) {
    ...
    <div className="max-w-4xl mx-auto px-4 py-10 fade-in">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-ig-text mt-3 mb-2">
          Your Ethical AI Adoption Profile
        </h1>
      ...
      <div className="bg-ig-berry rounded-2xl p-8 text-center text-white mb-6">
        ...
        <p className="text-sm opacity-90 max-w-md mx-auto mb-6 leading-relaxed">
          Inclusion Geeks works with organizations to turn assessments like this into action — through facilitated conversations, ethical AI workshops, and change management support that actually sticks.
        </p>
        <a
